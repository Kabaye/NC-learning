...
import com.netcracker.logger.annotation.utils.Pair;
...
public class LoggerAnnotationBeanPostProcessor implements BeanPostProcessor {
    private static final Logger LOGGER = LoggerFactory.getLogger(LoggerAnnotationBeanPostProcessor.class);
